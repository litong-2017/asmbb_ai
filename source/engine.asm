...
begin
        ...
        mov     edx, [.pText]
        stdcall TextCat, edx, txt '<div class="debug"><article><h1>Not finalized SQLite statements</h1><table border><tr><th>Statement</th><th>Called from</th></tr>'
...
.ovl_ok:
        stdcall TextCat, edx, txt "detected."
...
.end_count:
        ...
        stdcall TextCat, edx, eax
        stdcall StrDel, eax
        stdcall TextCat, edx, txt '<p>All allocated strings:<table border><tr><th>Handle</th><th>Content</th></tr>'

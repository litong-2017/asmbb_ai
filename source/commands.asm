...
permRegister    = 1             ; for the non loged "Anon" users.
...
permMultiQuote  = 4096          ; Can quote nested quotes.
...
begin
        ...
        mov     eax, mimeWOFF
        stdcall StrCompNoCase, [.extension], txt ".woff"
        jc      .mime_ok

        mov     eax, mimeWOFF2
        stdcall StrCompNoCase, [.extension], txt ".woff2"
        jc      .mime_ok
...
mimeWOFF  text "font/woff"
mimeWOFF2 text "font/woff2"

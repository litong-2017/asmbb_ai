...
.keywords_ok:
        ...
        stdcall GetParam, txt "ignore_style", gpString
        jc      .ignore_ok
        
        push    eax
        stdcall StrPtr, eax
        cinvoke sqliteBindText, [.stmt], 31, eax, [eax+string.len], SQLITE_TRANSIENT
        stdcall StrDel ; from the stack
...
;.save_keywords:
        ...
        stdcall GetPostString, [esi+TSpecialParams.post_array], txt "ignore_style", 0
        stdcall SetParamStr, txt "ignore_style", eax
        jc      .error_write

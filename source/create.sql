...
insert into Params values ('anon_perm', 3);     -- permRegister + permRead
insert into Params values ('chat_enabled', 1);
insert into Params values ('email_confirm', 1);
insert into Params values ('forum_header', '<h1>AsmBB <svg width="64" height="16" viewBox="0 0 64 16"><path d="m0 6 8 10h34l-6-6 28-2-50-8 8 8z"/></svg><small> Power</small></h1>');
...
create table Blacklist (
  ...
  ignoreID   integer not null references Users(id) on delete cascade,

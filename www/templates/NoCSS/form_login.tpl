...
|
  ...
  <form method="post" action="/!login">
    <fieldset>
      <legend>[const:ttlLogin]</legend>

      <p><label>[const:phUser]:<br><input type="text" value="" name="username" autofocus maxlength="256"></label>
      <p><label>[const:phPass]:<br><input type="password" value="" name="password" maxlength="1024" autocomplete="off"></label>
      <p><label><input type="checkbox" name="persistent" value="1"> [const:lblPers]</label>
      <p><input type="submit" name="submit" id="submit" value="[const:btnSubmit]">

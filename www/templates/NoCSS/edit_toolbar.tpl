...
<section class="jsonly">

  <a onclick="insertTag('source', ['*', '*', '^[b^]', '^[/b^]'], 1)" title="[const:Bold]">[const:iconBold]</a>
  <a onclick="insertTag('source', ['/', '/', '^[i^]', '^[/i^]'], 1)" title="[const:Italic]">[const:iconItalic]</a>
  <a onclick="insertTag('source', ['_', '_', '^[u^]', '^[/u^]'], 1)" title="[const:Underlined]">[const:iconUnderlined]</a>
  <a onclick="insertTag('source', ['-', '-', '^[s^]', '^[/s^]'], 1)" title="[const:Strikethrough]">[const:iconStrike]</a>
  <a onclick="insertTag('source', ['`', '`', '^[c^]', '^[/c^]'], 1)" title="[const:InlineCode]">[const:iconInlineCode]</a>
  <a onclick="insertTag('source', ['^[', '^]^[My link^]', '^[url=^]', '^[/url^]'], 1)" title="[const:Link]">[const:iconLink]</a>
  <a onclick="insertTag('source', ['^[!','^]^[My picture^]', '^[img=^]', '^[/img^]'], 1)" title="[const:Image]">[const:iconImage]</a>
  <a onclick="insertTag('source', [';quote', ';end', '^[quote=^]', '^[/quote^]'], 0)" title="[const:BlockQuote]">[const:iconQuote]</a>
  <a onclick="insertTag('source', [';begin', ';end', '^[code^]', '^[/code^]'], 0)" title="[const:CodeBlock]">[const:iconCodeBlock]</a>
  <a onclick="insertTag('source', ['^[?:-)^]', '', '^[:)^]', ''], 1)" title="[const:EmoSmile]">[const:iconSmile]</a>
  <a onclick="insertTag('source', ['^[?:-D^]', '', '^[:D^]', ''], 1)" title="[const:EmoLOL]">[const:iconLol]</a>
  <a onclick="insertTag('source', ['^[?rofl^]', '', '^[:rofl:^]', ''], 1)" title="[const:EmoROFL]">[const:iconRofl]</a>

  <a onclick="insertTag('source', ['^[?;-)^]', '', '^[;)^]', ''], 1)" title="[const:EmoWink]">[const:iconWink]</a>

  <a onclick="insertTag('source', ['^[?:-P^]', '', '^[:P^]', ''], 1)" title="[const:EmoTongue]">[const:iconTongue]</a>
  <a onclick="insertTag('source', ['^[?:-(^]', '', '^[:(^]', ''], 1)" title="[const:EmoSad]">[const:iconSad]</a>
  <a onclick="insertTag('source', ['^[?:\'-(^]', '', '^[:`(^]', ''], 1)" title="[const:EmoCry]">[const:iconCry]</a>
  <a onclick="insertTag('source', ['^[?>:-(^]', '', '^[>:(^]', ''], 1)" title="[const:EmoAngry]">[const:iconAngry]</a>
</section>
...
<script>
  ...
  function insertTag(id, tags, fInline) {
    var target = document.getElementById(id);
    if ( ! target ) return 0;

    var frm = document.getElementById("editform").elements["format"].value;
    if (! frm) frm = 0;

    var opentag = tags[2*frm];
    var closetag = tags[2*frm+1];

[case:[special:lang]|
  [equ:tPosts=Posts]
  [equ:tCreated=<span class="blabla">Created </span>[PostTime]]
  [equ:tEdited=<span class="blabla">Last edited: </span>[EditTime] by]
...
|
  [equ:tPosts=Постове]
  [equ:tCreated=<span class="blabla">Създадено на </span>[PostTime]]
  [equ:tEdited=<span class="blabla">Последно редактирано на </span>[EditTime] от]
...
|
  [equ:tPosts=Посты]
  [equ:tCreated=<span class="blabla">Создано </span>[PostTime]]
  [equ:tEdited=<span class="blabla">Отредактировано </span>[EditTime], участником]
...
|
  [equ:tPosts=Messages]
  [equ:tCreated=<span class="blabla">Crée le: </span>[PostTime]]
  [equ:tEdited=<span class="blabla">Édité le: </span>[EditTime] by]
...
|
  [equ:tPosts=Posts]
  [equ:tCreated=<span class="blabla">Erstellt am </span>[PostTime]]
  [equ:tEdited=<span class="blabla">Zuletzt geändert: </span>[EditTime] von]
...
<div class="post" id="[id]" author="[html:[UserName]]">

...
<div class="vote">
  ...
  [case:[special:canvote]||
    <button type="button" class="btn img-btn vote_dn [case:[VoteStatus]|voted|]" onclick="OnVote(this, -1)">
    ...
    <button type="button" class="btn img-btn vote_up [case:[VoteStatus]|||voted]" onclick="OnVote(this, 1)">
      <svg width="16" height="16" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style="stroke-width:1.5">

...
[case:[special:lang]|
  ...
  [equ:ttlIgnoreCSS=CSS for ignored messages]
...
|
  ...
  [equ:pVote=Гласуване]
  [equ:pMultiquote=Вложено цитиране]
  ...
  [equ:ttlIgnoreCSS=CSS за игнорираните съобщения]
...
|
  ...
  [equ:pMultiquote=Вложенные цитаты]
  [equ:pAdmin=Администратор]
  ...
  [equ:ttlIgnoreCSS=CSS для игнорированных сообщений]
...
|
  ...
  [equ:pVote=Vote]
  [equ:pMultiquote=Citations imbriquées]
  ...
  [equ:ttlIgnoreCSS=CSS pour les messages ignorés]
...
|
  ...
  [equ:pMultiquote=Verschachtelte Zitate]
  [equ:pAdmin=Administrator]
  ...
  [equ:ttlIgnoreCSS=CSS für die ignorierten Nachrichten]
...
<form class="settings msgbox" method="post" action="/!settings">
  ...
  <div class="tabbed">
    ...
    <section>
      ...
      <h3>[const:ttlIgnoreCSS]:</h3>
      <input type="text" value="[ignore_style]" name="ignore_style" class="settings" maxlen="512">
    ...
    <section>
      ...
      <ul class="checkboxes">
        <li><input type="checkbox" [user_perm0]  name="user_perm" id="up0"  value="1"><label for="up0">[const:pLogin]</label>
        <li><input type="checkbox" [user_perm1]  name="user_perm" id="up1"  value="2"><label for="up1">[const:pRead]</label>
        <li><input type="checkbox" [user_perm2]  name="user_perm" id="up2"  value="4"><label for="up2">[const:pPost]</label>
        <li><input type="checkbox" [user_perm3]  name="user_perm" id="up3"  value="8"><label for="up3">[const:pStart]</label>
        <li><input type="checkbox" [user_perm4]  name="user_perm" id="up4"  value="16"><label for="up4">[const:pEditOwn]</label>
        <li><input type="checkbox" [user_perm5]  name="user_perm" id="up5"  value="32"><label for="up5">[const:pEditAll]</label>
        <li><input type="checkbox" [user_perm6]  name="user_perm" id="up6"  value="64"><label for="up6">[const:pDelOwn]</label>
        <li><input type="checkbox" [user_perm7]  name="user_perm" id="up7"  value="128"><label for="up7">[const:pDelAll]</label>
        <li><input type="checkbox" [user_perm8]  name="user_perm" id="up8"  value="256"><label for="up8">[const:pChat]</label>
        <li><input type="checkbox" [user_perm9]  name="user_perm" id="up9"  value="512"><label for="up9">[const:pDownload]</label>
        <li><input type="checkbox" [user_perm10] name="user_perm" id="up10" value="1024"><label for="up10">[const:pAttach]</label>
        <li><input type="checkbox" [user_perm11] name="user_perm" id="up11" value="2048"><label for="up11">[const:pVote]</label>
        <li><input type="checkbox" [user_perm12] name="user_perm" id="up12" value="4096"><label for="up12">[const:pMultiquote]</label>
        <li><input type="checkbox" [user_perm31] name="user_perm" id="up31" value="$80000000"><label for="up31">[const:pAdmin]</label>
      </ul>
      ...
      <ul class="checkboxes">
        <li><input type="checkbox" [anon_perm0]  name="anon_perm" id="ap0"  value="1"><label for="ap0">[const:pRegister]</label>
        <li><input type="checkbox" [anon_perm1]  name="anon_perm" id="ap1"  value="2"><label for="ap1">[const:pRead]</label>
        <li><input type="checkbox" [anon_perm8]  name="anon_perm" id="ap8"  value="256"><label for="ap8">[const:pChat]</label>
        <li><input type="checkbox" [anon_perm9]  name="anon_perm" id="ap9"  value="512"><label for="ap9">[const:pDownload]</label>
      </ul>
